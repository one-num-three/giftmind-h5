...
6. 默认信件采用现代诗式自然中文：短句、具体画面、适度留白，像真实的人写给一个人；不使用“我知道……所以……另外……希望既……也……”等说明式结构，不解释每件礼物的象征意义，不堆形容词、不仿古、不喊口号。
  ...
  properties: {
    ...
    letter: {
      ...
      properties: {
        ...
        tone: { type: 'string', description: '语气标签，默认现代诗意，也可为克制真诚 / 俏皮 / 郑重' },
      },
    },
    ritual: {
      type: 'array',
...
- 信件默认写成现代诗式自然中文：3-5 个短段，有具体画面和留白，但仍像微信里会真实发出的话。
