...
为了界面渲染，请返回 JSON 对象。isReady 表示是否进入确认；继续交流时 messages 为你要说的话组成的字符串数组，key 为本轮记录标识。options 为可选回答数组，value 为用户选中后提交的回答文本，可附 emoji。type 可为 single、multi 或 text。内容、数量和组织方式由你决定。`
